...
int main() {
    ...
    ifstream in;
    clock_t begin,end;
    in.open("D:\\workspace\\clion-workspace\\algorithm-learn\\3.8\\graph.gfa");
    begin = clock();
    exSam.init();
    while(true){
        getline(in,s);
    ...
    exSam.build();
    in.close();
    in.open("D:\\workspace\\clion-workspace\\algorithm-learn\\3.8\\read200.fa");
    ofstream out;
    out.open("D:\\workspace\\clion-workspace\\algorithm-learn\\3.8\\res200.txt");
    while(in>>s){
